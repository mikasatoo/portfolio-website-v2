        ...
        <Layout bgColor="bg-butteryellow">
            <div className="flex flex-col h-full p-8 md:p-16 gap-10 md:gap-16 items-center font-[family-name:var(--font-geist-mono)] text-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 xl:mt-4 2xl:mt-6 gap-12 lg:gap-x-20 2xl:max-w-400 items-start justify-items-center">
                    ...
                    {/* **TODO: Get an image for my bookstore app (run it and take a screenshot) */}
                    <Frame name="Bookstore" imgPath="" imgAlt="Bookstore app UI" description="Full-stack bookstore web app (Oct 2023)" stack="React, Node.js, Express, MongoDB, Tailwind" githubLink="https://github.com/mikasatoo/bookstore-mern-stack" deployedLink="" />
                    ...
                    {/* **TODO: Get an image for my library app (add some books and take a screenshot) */}
                    <Frame name="Library App" imgPath="" imgAlt="My Library app UI" description="Personal library web app for adding books you've read or want to read (Jun - Jul 2023)" stack="JavaScript, HTML, CSS" githubLink="https://github.com/mikasatoo/library" deployedLink="https://mikasatoo.github.io/library/" />
                    <Frame name="Nook Inc. Landing Page" imgPath="nookinc2.png" imgAlt="Nook Inc. Homepage" description="My very first webpage <3 (May 2023)" stack="HTML, CSS" githubLink="https://github.com/mikasatoo/landing-page" deployedLink="https://mikasatoo.github.io/landing-page/" />
                    <Frame name="NBA Stats Visualiser" imgPath="nbastats.png" imgAlt="Lebron's made and missed shots" description="Python data project - processing and visualising real-time NBA statistics (Dec 2022 - Jan 2023)" stack="Python" githubLink="" deployedLink="" />
                </div>
            </div>
        </Layout>
    );
